...
sudo pacman -S tlp grim slurp xclip terminus-font git waybar hyprpaper distrobox bash-completion starship tmux neovim luarocks tree-sitter-cli less nodejs npm
